...
```{r, results="hide", message=FALSE, warning=FALSE, eval = FALSE}
fit = fit_bycatch(Takes ~ 1, data=d, time="Year", effort="Sets", family="nbinom2-hurdle",
  time_varying = FALSE)
```
...
plot_fitted(fitted_model=fit, xlab="Year", ylab = "Fleet-level bycatch", include_points = TRUE)
```
