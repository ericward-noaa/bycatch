...
## ---- fig.pos="placeHere", fig.cap = "Estimated fleet-level bycatch (not expanded by observer coverage), incorporating data on takes, effort."----
plot_fitted(fit, xlab="Year", ylab = "Fleet-level bycatch")

## ---- fig.pos="placeHere", fig.cap = "Estimated fleet-level bycatch (not expanded by observer coverage), incorporating data on takes, effort. Dots represent observed bycatch events."----
