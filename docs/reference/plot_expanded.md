...
plot_expanded is makes plots of the expanded bycatch estimates,
accounting for observer coverage and effort
...
- show_total:
  ...
  Whether to show the total predicted bycatch (by default, this is TRUE)
  or just the expanded unobserved events (=FALSE)
